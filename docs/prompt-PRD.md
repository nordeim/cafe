...
Now, help me meticulously browse and explore around this website at URL https://websitedemos.net/coffee-shop-04/ and then carefully and systematically extract its detailed UI/UX design cues and  design style, language and layout. Then create a detailed comprehensive website creation PRD that accurately duplicate the whole look and feel of this website, but customize it for a Singapore based local business. Make sure you explore the whole design of the website before planning how to create the required artifact.
